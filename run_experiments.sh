...
do
    ...
    python run_downstream.py -m train -d buzz_identification -u ssast -g upstream/ssast/hparams/config.yaml -n buzzid_ssast/$seed -o"data_root=/media/heitor/Research/raw_files/BuzzDataset/processed" -k result/pretrain/ssast/SSAST-Tiny-Patch-400.pth --seed $seed
    python run_downstream.py -m evaluate -d buzz_identification -u ssast -g upstream/ssast/hparams/config.yaml -n buzzid_ssast/$seed -o"data_root=/media/heitor/Research/raw_files/BuzzDataset/processed" -k result/pretrain/ssast/SSAST-Tiny-Patch-400.pth --seed $seed
...
do
    ...
    python run_downstream.py -m train -d beehive_strength -u ssast -g upstream/ssast/hparams/config.yaml -n beehive_str_ssast/$seed -o"data_root=/media/heitor/Research/raw_files/NectarDataset/beehive_strength/" -k result/pretrain/ssast/SSAST-Tiny-Patch-400.pth --seed $seed
    python run_downstream.py -m evaluate -d beehive_strength -u ssast -g upstream/ssast/hparams/config.yaml -n beehive_str_ssast/$seed -o"data_root=/media/heitor/Research/raw_files/NectarDataset/beehive_strength/" -k result/pretrain/ssast/SSAST-Tiny-Patch-400.pth --seed $seed
...
do
    ...
    python run_downstream.py -m train -d queenbee_detection -u ssast -g upstream/ssast/hparams/config.yaml -n qb_ssast/$seed -o"data_root=/media/heitor/Research/raw_files/nuhive/tasks/beehive_states_fold0-v2-full/16000" -k result/pretrain/ssast/SSAST-Tiny-Patch-400.pth --seed $seed
    python run_downstream.py -m evaluate -d queenbee_detection -u ssast -g upstream/ssast/hparams/config.yaml -n qb_ssast/$seed -o"data_root=/media/heitor/Research/raw_files/nuhive/tasks/beehive_states_fold0-v2-full/16000" -k result/pretrain/ssast/SSAST-Tiny-Patch-400.pth --seed $seed
